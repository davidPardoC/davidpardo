...
export default function Contact() {
  ...
  const sendContactData = () => {
    ...
    send('service_482h9cr', 'template_jmd0v8s', {
      name: name.value,
      email: email.value,
      ...
      Swal.fire({
        icon: 'success',
        title: 'I will answer a soon as posible.',
  ...
  return (
    <section>
      ...
      <div className="relative  rounded-md shadow-md  p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <form
            onSubmit={(e) => {
              e.preventDefault(), sendContactData();
            }}
